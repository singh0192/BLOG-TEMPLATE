    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_top">
          <div class="header_top_left">
            ...
            <li ><a href="/admin/postPage">POST CONTENT</a></li>
            </ul>
          </div>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_bottom">
          <div class="logo_area"><a href="/" class="logo"><img src="images/logo-dimensions.png" alt=""></a></div>
          <div class="add_banner"><div class="user" style="
    float: right;
">
